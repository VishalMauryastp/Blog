...
<div class="p-7">
    ...
    <h1 class="text-3xl font-[600]">Create New Blog Post</h1>
    <div class="mt-4 p-5 bg-white">
        <form action="<?= site_url('dashboard/blog/store'); ?>" method="POST" enctype="multipart/form-data" class=" ">
            ...
            <div class="mb-5">
                ...
                <textarea id="content" name="content" rows="6"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Enter the blog content" required></textarea>
            </div>
            ...
            <div class="flex items-start mb-5">
                <div class="flex items-center h-5">
                    <input id="isEnable" type="checkbox" name="isEnable" value="1"
            ...
            <div class="flex gap-3">
                ...
                <a class="bg-gray-300  hover:bg-blue-800 hover:text-white transition-all  px-5 py-2.5 rounded-[7px] " href="<?= site_url('dashboard/blog'); ?>">Back to Blog Posts</a>
