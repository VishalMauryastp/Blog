    ...
    <div class="px-4 sm:px-10">
        <div class="min-h-[500px]">
            <div class="grid md:grid-cols-2 justify-center items-center gap-10">
                <div class="max-md:order-1">
                    <p class="mt-4 mb-2 font-semibold text-blue-600"><span class="rotate-90 inline-block mr-2">|</span>
                        ALL IN
                        ONE
                        MEETING SCHEDULER</p>
                    <h1 class="md:text-5xl text-4xl font-bold mb-4 md:!leading-[55px]">Schedule meetings
                        effortlessly</h1>
                    <p class="mt-4 text-base leading-relaxed">Embark on a gastronomic journey with our curated
                        dishes, delivered
                        promptly to your doorstep. Elevate your dining experience today. Delve into the details and
                        let us enhance
                    ...
                    <div
                        ...
                        <input type='email' placeholder='Search Something...'
                            class="w-full outline-none bg-white pl-4" />
                        <button type='button'
                ...
                <div class="max-md:mt-12 h-full">
                    <img src="https://readymadeui.com/team-image.webp" alt="banner img"
        ...
        <div class="mt-28 bg-gray-50 px-4 sm:px-10 py-12">
            <div class="max-w-7xl mx-auto">
                <div class="md:text-center max-w-2xl mx-auto">
                    ...
                    <p>Unlock a world of possibilities with our exclusive features. Explore how our unique offerings
                        can
                ...
                <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
                    <div>
                        ...
                        <a href="javascript:void(0);"
                            class="text-blue-600 font-semibold inline-block mt-2 hover:underline">Learn
                            more</a>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-blue-600 mb-4 inline-block"
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-blue-600 mb-4 inline-block"
                            ...
                            <g fill="none" class="stroke-blue-600" stroke-miterlimit="10" stroke-width="30"
        ...
        <div class="mt-28">
            <div class="md:text-center max-w-2xl mx-auto">
                ...
                <p>Discover a range of exclusive features designed to elevate your experience. Learn how our
                    distinct
            ...
            <div class="mt-14">
                <div class="grid md:grid-cols-2 items-center gap-16">
                    ...
                    <div class="max-w-lg">
                        ...
                        <p>Experience unparalleled customization options tailored to suit your unique needs. Our
                            platform provides
                            a wide array of features, ensuring you have the flexibility to personalize your journey.
                        </p>
                        <button type="button"
                    ...
                    <div class="max-md:order-1 max-w-lg">
                        ...
                        <p>Unlock top-notch performance with our advanced optimization techniques. We prioritize
                            speed,
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
                    <div class="bg-white cursor-pointer rounded-md overflow-hidden group">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="px-4 py-2.5 text-white bg-blue-600 absolute bottom-0 right-0">June 10, 2023
                            </div>
                        </div>
                        <div class="p-6">
                    ...
                    <div class="bg-white cursor-pointer rounded-md overflow-hidden group">
                        <div class="relative overflow-hidden">
                            <img src="https://readymadeui.com/hacks-watch.webp" alt="Blog Post 2"
                                class="w-full h-60 object-cover group-hover:scale-125 transition-all duration-300" />
                            <div class="px-4 py-2.5 text-white bg-blue-600 absolute bottom-0 right-0">April 20, 2023
                            </div>
                        </div>
                        <div class="p-6">
                    ...
                    <div class="bg-white cursor-pointer rounded-md overflow-hidden group">
                        <div class="relative overflow-hidden">
                            <img src="https://readymadeui.com/prediction.webp" alt="Blog Post 3"
                                class="w-full h-60 object-cover group-hover:scale-125 transition-all duration-300" />
                            <div class="px-4 py-2.5 text-white bg-blue-600 absolute bottom-0 right-0">August 16,
                                2023</div>
                        </div>
                        <div class="p-6">
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid md:grid-cols-2 items-center gap-8">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <p>Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam
                                minim aute sit. Elit
                                occaecat officia et laboris Lorem minim. Officia do aliqua adipisicing ullamco in.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-28 bg-gray-50 px-4 sm:px-10 py-12 space-y-6">
            ...
            <div class="shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] border-2 border-transparent hover:border-blue-600 rounded-md transition-all"
                role="accordion">
                <button type="button" class="w-full font-semibold text-left py-5 px-6 flex items-center">
                    <span class="text-base mr-4">What are the dates and locations for the product launch
                        events?</span>
